...
filewrite.close()
PrintStatus("Your attack has been created in the SET home directory folder 'autorun'")
PrintInfo("Copy the contents of the folder to a CD/DVD/USB to autorun")

# if we are doing the custom pdf
if trigger == 2 or trigger == 3:
    choice1 = raw_input(setprompt("0", "Create a listener right now [yes|no]"))
