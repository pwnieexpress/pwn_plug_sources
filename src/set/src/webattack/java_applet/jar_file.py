...
#
import subprocess
subprocess.Popen("rm Java_Exploit.jar", stderr=subprocess.PIPE, stdout=subprocess.PIPE, shell=True)
...
"""
	...
	# move it into our html directory
        ...
        subprocess.Popen("cp Java_Exploit.jar ../../html/unsigned/unsigned.jar", shell=True).wait()
